...
1- The project was set up using Vite, as it is more modern and better suited for small-scale projects.
2- After setting up the project, I configured the endpoint in the .env file, implemented a service layer using Axios to fetch data, and used TanStack Query for state management, mainly for its simple data handling, caching, and performance benefits.”
3- I developed the UI, organized the layout and component structure, and used Bootstrap along with pure CSS for styling.
...
6- The codebase was cleaned up, the UI reached its final state, the component structure was organized, and final checks were completed.
